...
function initRoutes(app) {
  ...
  // ── Student: per-test class leaderboard — DISABLED. Students no longer
  //    have access to per-test leaderboards; they see their own results only
  //    (see /api/my-attempts and the submit response). Route kept as a stub
  //    returning 403 so any stale client code fails safely instead of
